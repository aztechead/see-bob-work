...
Leading the design and implementation of Viasat's terrestrial and space based content delivery network servicing airlines and residential customers on planet Earth. 
...
Google Cloud Platform (GCP), Kore.AI, Vertex AI, Apache Airflow, dbt, Kubernetes, Apache Kafka, Terragrunt, GitHub Actions, Python
...
#### Impact
Improved engagement and reduced bandwidth with ML personalization while enabling real-time insights and advancing AI adoption.
